# Chaos Maker — Project Context

## What This Is

An open source chaos engineering toolkit for web applications. It lets developers and SDETs inject controlled failures (network errors, latency, UI disruptions) into frontend apps to test resilience. Framework-agnostic — works with any web app and any E2E test framework.
...
- **Context:** Update this CLAUDE.md after every phase completion or significant decision.
...
Note: pnpm is available via corepack at `/opt/homebrew/Cellar/node@24/24.14.1/lib/node_modules/corepack/shims/pnpm` on the dev machine.
